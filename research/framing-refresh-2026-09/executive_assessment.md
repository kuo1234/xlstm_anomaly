...
> Under a frozen detector and a matched low-capacity probe, *causally-expanded recurrent internal
...
- The matched xLSTM/LSTM pair (F-v4 PASS) is what makes the *generic* recurrent claim credible. It
...
- The single strongest claim available today is generic-recurrent, not xLSTM-specific, and it is
  currently **one missing control away from being a temporal-span artifact**.
